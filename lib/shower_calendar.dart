...
class ShowerCalendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> daysList = List.generate(7, (index) {
      return Center(
        child: Text(  // can't render text, has to be a widget
          days[index], 
          textAlign: TextAlign.center,
        )
      );
    });
    final List<Widget> dayOffset = List.generate(3, (index) { // hard-coded for February
      return Center(
        child: Align(
      ...
      children: [
        SizedBox(
          ...
          child: GridView.count(
            ...
            children: daysList + dayOffset + List.generate(28, <Widget>(index) {
                ...
                else { img = Image.asset("assets/anteater6.PNG", height: 200); }
                return Stack(
                  children: [Align (
                      alignment: Alignment.topLeft,
                      child: Text( 
